...
exports.createUser = async function (userId, password, userName, userPhoneNum, userAddress, userGroup) {
    try {
        // 아이디 중복 확인
        ...
        const jsonStringifiedAddress = JSON.stringify(userAddress);
        const insertUserInfoParams = [userId, hashedPassword, userName, userPhoneNum, jsonStringifiedAddress, userGroup];
...
exports.postSignIn = async function (userId, password) {
    try {
        ...
        const selectId = userIdRows[0].userId
