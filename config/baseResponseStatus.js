module.exports = {
    ...
    SIGNIN_ID_EMPTY : { "isSuccess": false, "code": 400, "message":"아이디를 입력해주세요" },
    SIGNIN_ID_LENGTH : { "isSuccess": false, "code": 400, "message":"아이디는 30자리 미만으로 입력해주세요." },
    SIGNIN_ID_ERROR_TYPE : { "isSuccess": false, "code": 400, "message":"아이디를 형식을 정확하게 입력해주세요." },
    ...
    SIGNIN_ID_WRONG : { "isSuccess": false, "code": 404, "message": "아이디가 잘못 되었습니다." },
